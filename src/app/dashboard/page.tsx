...
import { FaUserMd, FaHospital, FaCalendarCheck, FaCheckCircle, FaClock } from 'react-icons/fa'
    ...
    <DashboardLayout>
      <div className='w-full max-w-7xl mx-auto p-6 md:p-8 text-slate-800'>
        ...
        <header className='flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4'>
          <div>
            <h1 className='text-3xl font-bold flex items-center gap-2 text-[#0B1528]'>
              Welcome Back, User_Name <span className='text-2xl'>👋</span>
            </h1>
          ...
          <div className='flex items-center gap-3 bg-white border border-[#E3ECFD] rounded-2xl px-4 py-3 shadow-sm'>
            ...
            <span className='text-[#2B3E64] text-sm'>⌄</span>
          </div>
        </header>
